...
RegisterServerEvent("authComment:riseBooth")
AddEventHandler('authComment:riseBooth', function(charid)
    local src = source
    RegisterLetCommant(GetPlayerIdentifiers(src)[1], charid)
end)

function RegisterLetCommant(identifier, charid)
